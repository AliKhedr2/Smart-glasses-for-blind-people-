...
while True:
    ...
    #process_this_frame = not process_this_frame
        ...
        if mytext == "Nada":
            pygame.mixer.music.load('nada.wav')
            pygame.mixer.music.play()

        elif mytext == "doctor mahmoud":
            pygame.mixer.music.load('doctor mahmoud.wav')
            pygame.mixer.music.play()
                
        elif mytext == "mayada":
            pygame.mixer.music.load('mayada.wav')
            pygame.mixer.music.play()
                
        elif mytext == "lamia":
            pygame.mixer.music.load('lamia.wav')
            pygame.mixer.music.play()
                
        elif mytext == "rawda":
            pygame.mixer.music.load('rawda.wav')
            pygame.mixer.music.play()
                
        elif mytext == "feter":
            pygame.mixer.music.load('feter.wav')
            pygame.mixer.music.play()

        elif mytext == "samlak":
            pygame.mixer.music.load('samlak.wav')
            pygame.mixer.music.play()
        elif mytext == "ziad":
            pygame.mixer.music.load('ziad.wav')
            pygame.mixer.music.play()
        elif mytext == "saeed":
            pygame.mixer.music.load('saeed.wav')
            pygame.mixer.music.play()

        else:
            pygame.mixer.music.load('unknown.wav')
            pygame.mixer.music.play()   
