...
##    # Display the results
    ...
    # Display the resulting image
        ...
        if mytext == "Nada":
            winsound.PlaySound('nada.wav',winsound.SND_FILENAME)
            
        elif mytext == "doctor mahmoud":
            winsound.PlaySound('doctor.wav',winsound.SND_FILENAME)
            
        elif mytext == "mayada":
            winsound.PlaySound('mayada.wav',winsound.SND_FILENAME)
            
        elif mytext == "lamia":
            winsound.PlaySound('lamia.wav',winsound.SND_FILENAME)
            
        elif mytext == "rawda":
            winsound.PlaySound('rawda.wav',winsound.SND_FILENAME)
            
        elif mytext == "feter":
            winsound.PlaySound('feter.wav',winsound.SND_FILENAME)

        elif mytext == "samlak":
            winsound.PlaySound('samlak.wav',winsound.SND_FILENAME)
        elif mytext == "ziad":
            winsound.PlaySound('ziad.wav',winsound.SND_FILENAME)
        elif mytext == "saeed":
            winsound.PlaySound('saeed.wav',winsound.SND_FILENAME)
        else:
            winsound.PlaySound('unknown.wav',winsound.SND_FILENAME)
